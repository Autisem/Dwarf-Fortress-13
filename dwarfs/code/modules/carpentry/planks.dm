...
GLOBAL_LIST_INIT(plank_recipes, list (
	new/datum/stack_recipe("Weapon Hilt", /obj/item/weapon_hilt, 2, 2, time=5 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Tool Handle", /obj/item/tool_handle, 2, time=5 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Bucket", /obj/item/reagent_containers/glass/bucket, 5, time=20 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Bed", /obj/structure/bed, 10, time=25 SECONDS, tools=TOOL_AXE),
	...
	new/datum/stack_recipe("Bowl", /obj/item/reagent_containers/glass/plate/bowl, 3, time=15 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Stick", /obj/item/stick, res_amount=2, time=5 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Wooden Cup", /obj/item/reagent_containers/glass/cup, 2, time=15 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Torch Handle", /obj/item/torch_handle, res_amount=2, time=5 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Rolling Pin", /obj/item/kitchen/rollingpin, 3, time=20 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Barrel", /obj/structure/barrel, 10, time=50 SECONDS, tools=TOOL_AXE),
	new/datum/stack_recipe("Wooden Crate", /obj/structure/closet/crate/wooden, 8, time=50 SECONDS, tools=TOOL_AXE),
