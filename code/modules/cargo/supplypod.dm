...
/obj/structure/closet/supplypod/Initialize(mapload, customStyle = FALSE)
	. = ..()
	if (!loc)
		var/shippingLane = GLOB.areas_by_type[/area/supplypod_temp_holding] //temporary holder for supplypods mid-transit
...
/obj/structure/closet/supplypod/proc/handleReturnAfterDeparting(atom/movable/holder = src)
	...
	var/shippingLane = GLOB.areas_by_type[/area/supplypod_temp_holding]
