...
#define LOG_VIRUS			(1 << 11)
#define LOG_LOOC	        (1 << 12)
...
#define INDIVIDUAL_SHOW_ALL_LOG		(LOG_ATTACK | LOG_SAY | LOG_WHISPER | LOG_EMOTE | LOG_DSAY | LOG_OOC | LOG_ADMIN | LOG_OWNERSHIP | LOG_GAME | LOG_LOOC | LOG_ADMIN_PRIVATE | LOG_ASAY | LOG_VIRUS)
