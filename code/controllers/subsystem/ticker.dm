...
/datum/controller/subsystem/ticker/proc/equip_characters()
	for(var/mob/dead/new_player/new_player_mob as anything in GLOB.new_player_list)
		...
		new_player_human.equipOutfit(new_player_human.client.prefs.loadout ? new_player_human.client.prefs.loadout : /datum/outfit/dwarf)// if for SOME reason the pref is null
