...
/datum/component/pellet_cloud/Initialize(projectile_type=/obj/item/shrapnel, magnitude=5)
	if(!isammocasing(parent) && !islandmine(parent) && !issupplypod(parent) && !istype(parent, /obj/item/extinguisher))
	...
	else if(islandmine(parent) || issupplypod(parent) || istype(parent, /obj/item/extinguisher))
		radius = magnitude
